        ...
        .directive('profileCmp', ['userService', 'statusService', function (userService, statusService) {
            return {
                ...
                link: function (scope) {
                    ...
                    scope.getAva = function(ava){
                        return !ava || ava == '//sailplay.cdnvideo.ru/static/no_avatar100x100.jpg' ? 'image/empty_pic.png' : ava;
                    };
