...
(function () {
  ...
  angular.module('sp.actions', [])
    ...
    .directive('sailplayActions', ["sp_api", "sp", "spAction", "tagHelper", function (sp_api, sp, spAction, tagHelper) {
