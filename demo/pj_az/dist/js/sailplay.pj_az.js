...
angular.module('sp_pj_az', [
  ...
  .directive('sailplayPjAz', ["$rootScope", "$locale", "headerBg", "$filter", function ($rootScope, $locale, headerBg, $filter) {
    return {
      restrict: 'E',
      replace: true,
      scope: true,
...
angular.module('core', [
  ...
  .run(["sp", "ipCookie", "sp_api", "$rootScope", function (sp, ipCookie, sp_api, $rootScope) {
