...
var SAILPLAY = (function () {
  ...
  sp.on('login', function (auth_hash) {
    ...
    if(_config.remote_login && typeof Porthole !== 'undefined'){

      var windowProxy, login_frame;
      ...
      function onMessage(messageEvent) {
        ...
        if(messageEvent.data.name == 'login.success'){
          document.body.removeChild(login_frame);
      ...
      login_frame = document.getElementById('sp_auth_frame');
      ...
      login_frame = document.createElement('iframe');
      login_frame.style.backgroundColor = '#fff';
      login_frame.style.position = 'fixed';
      login_frame.style.zIndex = '100000';
      login_frame.style.width = '90%';
      login_frame.style.height = '90%';
      login_frame.style.maxHeight = '400px';
      login_frame.style.maxWidth = '400px';
      login_frame.style.top = '0';
      login_frame.style.left = '0';
      login_frame.style.bottom = '0';
      login_frame.style.right = '0';
      login_frame.style.margin = 'auto';
      login_frame.id = 'sp_auth_frame';
      login_frame.name = 'sp_auth_frame';
      login_frame.src = _config.DOMAIN + '/users/auth-page/?partner_id=' + _config.partner.id + '&dep_id=' + _config.dep_id;
      document.body.appendChild(login_frame);

      windowProxy = new Porthole.WindowProxy('', 'sp_auth_frame');
