...
(function () {
  ...
  angular.module('sg.directives.actions', [])
    ...
    .directive('actionsD', ["api", "actionS", "sp", "$timeout", "userS", function (api, actionS, sp, $timeout, userS) {
      return {
        restrict: 'E',
        replace: false,
...
(function () {
  ...
  angular.module('sg.directives.auth', [])
    ...
    .directive('authD', ["api", "sp", "$timeout", "$http", "$window", function (api, sp, $timeout, $http, $window) {
      return {
        restrict: 'E',
