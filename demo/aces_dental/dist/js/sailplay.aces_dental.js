...
(function () {
  ...
  angular.module('aces_dental', ['core', 'ui', 'sp', 'templates'])
    ...
    .directive('sailplayAd', ["$rootScope", "$locale", function ($rootScope, $locale) {
...
(function () {
  ...
  angular.module('core', [
    ...
    .run(["sp", "ipCookie", "sp_api", "$rootScope", "reviews_data", "spProfileTag", "actions_data", function (sp, ipCookie, sp_api, $rootScope, reviews_data, spProfileTag, actions_data) {

      $rootScope.config = window.acces_dental_config || {};
      ...
      // Review action tags
      var TAGS = reviews_data.map(function (item) {
      ...
      // Tag for Refer friend
      TAGS.push(actions_data.system.inviteFriend.tag);
...
(function () {
  ...
  angular.module('sp.actions', [])
    ...
    .directive('sailplayActions', ["sp_api", "sp", "spAction", "reviews_data", "tagHelper", function (sp_api, sp, spAction, reviews_data, tagHelper) {
...
(function () {
  ...
  angular.module('sp.profile', [])
    ...
    .constant('spProfileTag', 'Fill profile')
