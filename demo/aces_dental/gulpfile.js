(function () {
  ...
  gulp.task('javascript.concat', ['build.templates'], function () {
    return gulp.src([
      ...
      .pipe(concat('sailplay.aces_dental.js'))
      .pipe(gulp.dest(__dirname + '/dist/js/'));
  });

  gulp.task('javascript.ngAnnotate', ['javascript.concat'], function () {
    return gulp.src(__dirname + '/dist/js/sailplay.aces_dental.js')
      .pipe(ngAnnotate({
        add: true
      }))
      .pipe(gulp.dest(__dirname + '/dist/js/'));
  ...
  gulp.task('build.less', function () {
    return gulp.src(__dirname + '/src/less/sailplay.aces_dental.less')
      .pipe(less({
