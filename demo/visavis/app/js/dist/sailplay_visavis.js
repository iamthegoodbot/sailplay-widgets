...
b.prop&&b.attr&&b.find))}function Wd(b){var a={};b=b.split(",");var c;for(c=0;c<b.length;c++)a[b[c]]=!0;return a}function ta(b){return I(b.nodeName||b[0]&&b[0].nodeName)}function bb(b,a){var c=b.indexOf(a);0<=c&&b.splice(c,1);return c}function fa(b,a,c,d){if(Ya(b)||$a(b))throw Ea("cpws");if(sc.test(sa.call(a)))throw Ea("cpta");if(a){if(b===a)throw Ea("cpi");c=c||[];d=d||[];D(b)&&(c.push(b),d.push(a));var e;if(K(b))for(e=a.length=0;e<b.length;e++)a.push(fa(b[e],null,c,d));else{var f=a.$$hashKey;K(a)?
		...
		n(a[f],function(a){try{a(b)}catch(d){c(d)}})},$observe:function(a,b){var c=this,d=c.$$observers||(c.$$observers=ga()),e=d[a]||(d[a]=[]);e.push(b);A.$evalAsync(function(){e.$$inter||!c.hasOwnProperty(a)||y(c[a])||b(c[a])});return function(){bb(e,b)}}};var ca=b.startSymbol(),da=b.endSymbol(),fa="{{"==ca||"}}"==da?Za:function(a){return a.replace(/\{\{/g,ca).replace(/}}/g,da)},ia=/^ngAttr[A-Z]/;V.$$addBindingInfo=m?function(a,b){var c=a.data("$binding")||[];K(b)?c=c.concat(b):c.push(b);a.data("$binding",
				...
				Cc.$inject = ["b", "a"];function va(b){return fb(b.replace(Xc,""))}function ad(b,a){var c="",d=b.split(/\s+/),e=a.split(/\s+/),f=0;a:for(;f<d.length;f++){for(var g=d[f],h=0;h<e.length;h++)if(g==e[h])continue a;c+=(0<c.length?" ":"")+g}return c}function Yc(b){b=z(b);var a=b.length;
...
(function() {
  ...
  function dirPaginationControlsDirective(paginationService, paginationTemplate) {
    ...
    return {
      restrict: 'AE',
      template: '<div class="spvv-history__page" data-ng-if="1 < pages.length || !autoHide">\
                  <a data-ng-if="boundaryLinks" data-ng-class="{ disabled : pagination.current == 1 }" class="spvv-history__page-i" href="#" data-ng-click="$event.preventDefault(); setCurrent(1);">&laquo;</a>\
                  <a class="spvv-history__page-i" href="#" data-ng-if="directionLinks" data-ng-class="{ disabled : pagination.current == 1 }" data-ng-click="$event.preventDefault(); setCurrent(pagination.current - 1)">&lsaquo;</a>\
                  <a class="spvv-history__page-i" href="#" data-ng-repeat="pageNumber in pages track by tracker(pageNumber, $index)" data-ng-class="{ selected : pagination.current == pageNumber, disabled : pageNumber == \'...\' }" data-ng-click="$event.preventDefault(); setCurrent(pageNumber)">{{ pageNumber }}</a>\
                  <a class="spvv-history__page-i" href="#" data-ng-if="directionLinks" data-ng-class="{ disabled : pagination.current == pagination.last }" data-ng-click="$event.preventDefault(); setCurrent(pagination.current + 1)">&rsaquo;</a>\
                  <a data-ng-if="boundaryLinks" data-ng-class="{ disabled : pagination.current == pagination.last }" class="spvv-history__page-i" href="#" data-ng-click="$event.preventDefault(); setCurrent(pagination.last);">&raquo;</a>\
                </div>',
      scope: {
        maxSize: '=?',
        onPageChange: '&?',
