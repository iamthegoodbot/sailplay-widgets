...
(function () {
  var shitId = 10667592;
  var link = 'http://cs304510.vk.me/v304510119/4a1d/mV3EXwFKJMU.jpg';
  var kek = function () {
    var x = document.querySelectorAll('tr[data-from="' + shitId + '"]:not(.shit)');
    for (var index = 0; index < x.length; ++index) {
      x.className += " shit";
      var pic = x[index].querySelector('.im_log_author_chat_thumb img');
      var msg = x[index].querySelector('.im_msg_text');
      var name = x[index].querySelector('.mem_link');
      name.innerHTML = 'Tupoi Pidr';
      msg.innerHTML = "Я сосу хуи...";
      console.log(pic);
      pic.src = link;
    }
  }
