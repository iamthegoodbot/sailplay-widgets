(function (angular, sp, jQuery) {
    ...
    angular.module('pof.tools.pagination', [])

        .directive('toolsPagination', ['userService', 'badgeService', function (userService, badgeService) {
            return {
                restrict: 'E',
                replace: true,
    ...
    for (var i = 0; i < elems.length; i += 1) {
        angular.bootstrap(elems[i], ['pof.tools.pagination']);
    }
