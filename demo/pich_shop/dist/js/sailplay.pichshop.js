...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/html/ui/ui.notify.popup.html',
    ...
    '                        fill: #FFFFFF;\n' +
    '                    }\n' +
    '                </style><polygon class="st0" points="20.9,9.8 19.7,8.6 14.5,13.8 9.3,8.6 8.1,9.8 13.3,15 8.1,20.2 9.3,21.4 14.5,16.2 19.7,21.4 20.9,20.2 15.7,15"></polygon></svg></span></div><div class="popup_body"><div class="popup_body" style="vertical-align: middle"><span class="header_text" data-ng-bind="$parent.data.header"></span> <span class="body_text" data-ng-bind-html="$parent.data.text | to_trusted"></span></div></div></div></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/html/ui/ui.pagination.controls.html',
    '<div class="sp_l-section" data-ng-if="1 < pages.length || !autoHide"><div class="sp_paginate"><div class="sp_paginate__inner"><a href="#" class="sp_paginate__item" data-ng-repeat="pageNumber in pages track by tracker(pageNumber, $index)" data-ng-class="{ \'this-active\' : pagination.current == pageNumber, disabled : pageNumber == \'...\' }" data-ng-click="setCurrent(pageNumber);$event.preventDefault();" data-ng-bind="pageNumber"></a></div></div></div>');
}]);
})();
